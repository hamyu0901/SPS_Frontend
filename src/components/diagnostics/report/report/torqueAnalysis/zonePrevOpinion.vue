...
export default {
    ...
    mounted(){
        this.robotInfo.forEach(el => {
            this.datas.headerPrevText = el.previolation_value.comment
            this.datas.bodyPrevText = el.previolation_value.comment
        })
    },
    watch: {
        bindingCatch(){
    ...
    methods:{
        ...
        inputPrevTextArea(opinion){
            this.datas.headerPrevText = opinion
            this.$emit('inputPrevZoneOpinion', this.datas.headerPrevText)
        },
    }
}
</script>
