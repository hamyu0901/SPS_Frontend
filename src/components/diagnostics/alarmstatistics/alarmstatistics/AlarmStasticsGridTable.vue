        ...
        <v-data-table class="elevation-0 dataTable" hide-actions :headers="headers" :items="datas"
            ...
            <template slot="items" slot-scope="props">
                <tr :ref="props.index" @click="itemClicked(props, pagination.page)" :key="props.index">
                    ...
                    <td v-if="props.item.level == '하'"><img src="@/images/img_alarm_low.png"/></td>
                    <td v-else-if="props.item.level == '중'"><img src="@/images/img_alarm_middle.png"/></td>
                    <td v-else-if="props.item.level == '상'"><img src="@/images/img_alarm_high.png"/></td>
                    <td v-else></td>
                </tr>
            </template>
        </v-data-table>
        ...
        getContentData() {
            if (this.contentData.length !== 0) {
                if (this.contentData !== this.datas) {
                    ...
                    setTimeout(function() {
                        _this.itemClicked(_this.datas[0],1);
                    }, 500);
                }
            } else {
                this.datas = [];
